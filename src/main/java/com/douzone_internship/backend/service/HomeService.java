...
public class HomeService {
    ...
    public ResponseEntity<ClinicListResponseDTO> getClinicNameAndCode(String clinicName) {
         ...
         List<Clinic> clinics = clinicRepository.findByClinicCdContaining(clinicName);

         if (clinics == null || clinics.isEmpty()) {
             ClinicListResponseDTO empty = ClinicListResponseDTO.builder()
                     .clinicResponseDTOList(List.of())
                     .build();
    ...
    public ResponseEntity<HospitalResponseDTO> getHospitalName(String location, String hospitalName) {
        ...
        List<Hospital> hospitals = hospitalRepository.findBySigungu_SgguCdAndNameContainingIgnoreCase(location, hospitalName);
